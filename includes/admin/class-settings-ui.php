...
class Settings_UI {
    ...
    public static function register_menu() {
        ...
        \add_action('admin_enqueue_scripts', function($hook) {
            ...
            // Define callback BEFORE script
            \wp_register_script('kitgenix-captcha-for-cloudflare-turnstile-admin-turnstile', false, [], (defined('KitgenixCaptchaForCloudflareTurnstileVERSION') ? \constant('KitgenixCaptchaForCloudflareTurnstileVERSION') : null), true);
            \wp_add_inline_script(
                'kitgenix-captcha-for-cloudflare-turnstile-admin-turnstile',
                'window.KitgenixCaptchaForCloudflareTurnstileAdminTurnstileReady=function(){try{var el=document.getElementById("kitgenix-captcha-for-cloudflare-turnstile-test-widget");if(el&&typeof turnstile!=="undefined"&&!el.dataset.rendered){turnstile.render(el,{sitekey:' . \wp_json_encode($site_key) . ',theme:' . \wp_json_encode($settings['theme'] ?? 'auto') . ',size:' . \wp_json_encode($settings['widget_size'] ?? 'normal') . ',appearance:' . \wp_json_encode($settings['appearance'] ?? 'always') . ',callback:function(){var ok=document.getElementById("kitgenix-captcha-for-cloudflare-turnstile-test-success");if(ok){ok.style.display="block";}}});el.dataset.rendered="true";}}catch(e){if(window.console)console.error(e);}};',
                'before'
            );
            \wp_enqueue_script('kitgenix-captcha-for-cloudflare-turnstile-admin-turnstile');

            // Load api.js with onload pointing at our callback
            ...
            \wp_enqueue_script(
                'kitgenix-captcha-for-cloudflare-turnstile-admin-turnstile-api',
                $url,
                [],
                (defined('KitgenixCaptchaForCloudflareTurnstileVERSION') ? \constant('KitgenixCaptchaForCloudflareTurnstileVERSION') : null),
                true
            );
        });
    }
        ...
        <div class="wrap" id="kitgenix-captcha-for-cloudflare-turnstile-admin-app">
            <div class="kitgenix-captcha-for-cloudflare-turnstile-settings-intro">
                ...
                <div class="kitgenix-captcha-for-cloudflare-turnstile-intro-links">
                    <a href="<?php echo \esc_url('https://kitgenix.com/plugins/kitgenix-captcha-for-cloudflare-turnstile/documentation/'); ?>" target="_blank" rel="noopener"><?php echo \esc_html(\__('View Plugin Documentation', 'kitgenix-captcha-for-cloudflare-turnstile')); ?></a>
                    <a href="<?php echo \esc_url('https://wordpress.org/support/plugin/kitgenix-captcha-for-cloudflare-turnstile/reviews/#new-post'); ?>" target="_blank" rel="noopener"><?php echo \esc_html(\__('Consider Leaving Us a Review', 'kitgenix-captcha-for-cloudflare-turnstile')); ?></a>
                    <a href="<?php echo \esc_url('https://wordpress.org/support/plugin/kitgenix-captcha-for-cloudflare-turnstile/'); ?>" target="_blank" rel="noopener"><?php echo \esc_html(\__('Get Support', 'kitgenix-captcha-for-cloudflare-turnstile')); ?></a>
                    <a href="<?php echo \esc_url('https://buymeacoffee.com/kitgenix'); ?>" target="_blank" rel="noopener"><?php echo \esc_html(\__('Buy us a coffee', 'kitgenix-captcha-for-cloudflare-turnstile')); ?></a>
                </div>
            </div>
            ...
            <form method="post" action="options.php" autocomplete="off" novalidate>
                ...
                <div class="kitgenix-captcha-for-cloudflare-turnstile-card">
                  ...
                  <div class="kitgenix-captcha-for-cloudflare-turnstile-section-content">
                    <p style="margin-bottom:18px;font-size:1.08em;max-width:100%;">
                      ...
                      <a href="<?php echo \esc_url('https://dash.cloudflare.com/?to=/:account/turnstile'); ?>" target="_blank" rel="noopener" style="color:var(--jt-accent);font-weight:600;">https://dash.cloudflare.com/?to=/:account/turnstile</a>
                    </p>
                    ...
                    <table class="form-table" style="margin-top:28px;">
                      <tr>
                        <th scope="row" style="vertical-align:top;"><label style="margin-bottom:10px; margin-top:0;"><?php echo \esc_html__('Test Cloudflare Turnstile Response', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></label></th>
                        <td>
                          <div id="kitgenix-captcha-for-cloudflare-turnstile-test-widget" class="cf-turnstile"
                               ...
                               data-appearance="<?php echo \esc_attr($settings['appearance'] ?? 'always'); ?>"></div>
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description" style="margin-top:6px;"><?php echo \esc_html__('Select the visual style for the widget.', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description" style="margin-top:6px;"><?php echo \esc_html__('Pick a size that fits your layout.', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description" style="margin-top:6px;"><?php echo \esc_html__('Control how the widget is displayed.', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select id="language" name="kitgenix_captcha_for_cloudflare_turnstile_settings[language]">
                                    ...
                                    <?php
                                    $langs = ['en','es','fr','de','it','pt','ru','zh-CN','zh-TW','ja','ko','ar','tr','pl','nl','sv','fi','da','no','cs','hu','el','he','uk','ro','bg','id','th','vi'];
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description" style="margin-top:6px;"><?php echo \esc_html__('Override the default inline error shown to users when verification fails.', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description" style="margin-top:6px;"><?php echo \esc_html__('Optional extra text appended to error messages (e.g., support instructions).', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></p>
                            </td>
                        </tr>
                    </table>
                  </div>
                    ...
                    <div class="kitgenix-captcha-for-cloudflare-turnstile-section-content">
                        <table class="form-table">
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" id="replay_protection" name="kitgenix_captcha_for_cloudflare_turnstile_settings[replay_protection]" value="1" <?php checked(!empty($settings['replay_protection']), true); ?> />
                                    <span class="description">
                        ...
                        <table class="form-table">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="description" style="margin-top:6px;"><?php echo \esc_html__('Useful for membership sites or intranets. Applies to all integrations.', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></p>
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="kitgenix-captcha-for-cloudflare-turnstile-card">
                    ...
                    <div class="kitgenix-captcha-for-cloudflare-turnstile-section-content">
                        <table class="form-table">
                            ...
                            <tr>
                                <th><label for="trusted_proxies"><?php echo \esc_html(\__('Trusted Proxy IPs (one per line)', 'kitgenix-captcha-for-cloudflare-turnstile')); ?></label></th>
                                <td>
                                    ...
                                    <p class="description" style="margin-top:6px;">
                                        <?php echo \esc_html(\__('Accepts IPv4/IPv6 or CIDR ranges, e.g. 203.0.113.10 or 2001:db8::/32. Only when REMOTE_ADDR matches one of these will proxy headers be used.', 'kitgenix-captcha-for-cloudflare-turnstile')); ?>
                                    </p>
                                </td>
                            </tr>
                        </table>
                ...
                <div class="kitgenix-captcha-for-cloudflare-turnstile-card">
                    ...
                    <div class="kitgenix-captcha-for-cloudflare-turnstile-section-content">
                        <p class="description" style="margin:-6px 0 12px 0;"><?php echo \esc_html__('Renders Turnstile on core WordPress forms:', 'kitgenix-captcha-for-cloudflare-turnstile'); ?>
                        ...
                        <table class="form-table">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="description" style="margin-top:6px;"><?php echo \esc_html__('Adds a Turnstile widget to the forms listed below and validates on POST only.', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></p>
                                </td>
                            </tr>
                        </table>
                        <table class="form-table">
                ...
                <div class="kitgenix-captcha-for-cloudflare-turnstile-card">
                    ...
                    <div class="kitgenix-captcha-for-cloudflare-turnstile-section-content">
                        <p class="description" style="margin:-6px 0 12px 0;"><?php echo \esc_html__('Elementor Pro Forms: container renders after fields; server-side validation via Elementor hooks. Elementor (free): auto-injection above the submit button.', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></p>
                        <table class="form-table">
                            <tr>
                ...
                <div class="kitgenix-captcha-for-cloudflare-turnstile-card">
                    ...
                    <div class="kitgenix-captcha-for-cloudflare-turnstile-section-content">
                        <p class="description" style="margin:-6px 0 12px 0;"><?php echo \esc_html__('Widget renders near the submit area; server-side validation uses WPForms process hook (works with AJAX).', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></p>
                        <table class="form-table">
                            <tr>
                ...
                <div class="kitgenix-captcha-for-cloudflare-turnstile-card">
                    ...
                    <div class="kitgenix-captcha-for-cloudflare-turnstile-section-content">
                        <p class="description" style="margin:-6px 0 12px 0;"><?php echo \esc_html__('Widget is inserted before the submit button; AJAX-friendly validation via Fluent’s submit filter.', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></p>
                        <table class="form-table">
                            <tr>
                ...
                <div class="kitgenix-captcha-for-cloudflare-turnstile-card">
                    ...
                    <div class="kitgenix-captcha-for-cloudflare-turnstile-section-content">
                        <p class="description" style="margin:-6px 0 12px 0;"><?php echo \esc_html__('Widget renders immediately before the submit button; server-side validation sets the top-level error container.', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></p>
                        <table class="form-table">
                            <tr>
                ...
                <div class="kitgenix-captcha-for-cloudflare-turnstile-card">
                    ...
                    <div class="kitgenix-captcha-for-cloudflare-turnstile-section-content">
                        <p class="description" style="margin:-6px 0 12px 0;"><?php echo \esc_html__('Widget renders before the submit button; validation runs during entry validation.', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></p>
                        <table class="form-table">
                            <tr>
                ...
                <div class="kitgenix-captcha-for-cloudflare-turnstile-card">
                    ...
                    <div class="kitgenix-captcha-for-cloudflare-turnstile-section-content">
                        <p class="description" style="margin:-6px 0 12px 0;"><?php echo \esc_html__('Widget is injected before the first submit control; validation uses the CF7 validation filter (AJAX and non-AJAX).', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></p>
                        <table class="form-table">
                            <tr>
                ...
                <div class="kitgenix-captcha-for-cloudflare-turnstile-card">
                    ...
                    <div class="kitgenix-captcha-for-cloudflare-turnstile-section-content">
                        <p class="description" style="margin:-6px 0 12px 0;"><?php echo \esc_html__('Widget is added alongside the submit markup; validation uses Forminator’s submit errors filter (AJAX-safe).', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></p>
                        <table class="form-table">
                            <tr>
                ...
                <div class="kitgenix-captcha-for-cloudflare-turnstile-card">
                    ...
                    <div class="kitgenix-captcha-for-cloudflare-turnstile-section-content">
                        <p class="description" style="margin:-6px 0 12px 0;"><?php echo \esc_html__('Widget is injected into Jetpack contact forms; validation occurs via the spam check hook and blocks submission with a surfaced error.', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></p>
                        <table class="form-table">
                            <tr>
                ...
                <div class="kitgenix-captcha-for-cloudflare-turnstile-card">
                    ...
                    <div class="kitgenix-captcha-for-cloudflare-turnstile-section-content">
                        <p class="description" style="margin:-6px 0 12px 0;"><?php echo \esc_html__('Widget is prepended before the submit button in Kadence Blocks Form; validation returns a form-level error without killing AJAX.', 'kitgenix-captcha-for-cloudflare-turnstile'); ?></p>
                        <table class="form-table">
                            <tr>
            ...
            <!-- Export / Import -->
                <div class="kitgenix-captcha-for-cloudflare-turnstile-card">
                    ...
                    <div class="kitgenix-captcha-for-cloudflare-turnstile-section-content">
                        ...
                        <!-- Export -->
                        <h3 style="margin-top:10px;"><?php echo \esc_html(\__('Export', 'kitgenix-captcha-for-cloudflare-turnstile')); ?></h3>
                        <p><?php echo \esc_html(\__('Download your current settings as JSON for backup or migration.', 'kitgenix-captcha-for-cloudflare-turnstile')); ?></p>
                        ...
                        <p><?php echo \esc_html(\__('Upload a previously exported JSON file or paste JSON below.', 'kitgenix-captcha-for-cloudflare-turnstile')); ?></p>
                            ...
                            <table class="form-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p class="description" style="margin-top:6px;"><?php echo \esc_html(\__('“Merge” only updates provided keys. “Replace” overwrites the full settings object.', 'kitgenix-captcha-for-cloudflare-turnstile')); ?></p>
                                    </td>
                                </tr>
                                <tr>

...
final class Ultimate_Member {
    ...
    private static function render_widget( string $owner ): void {
        ...
        echo '<div class="cf-turnstile"'
            . \KitgenixCaptchaForCloudflareTurnstile\Core\Script_Handler::get_widget_data_attributes( 'ultimatemember', $site_key ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- pre-escaped markup from Script_Handler.

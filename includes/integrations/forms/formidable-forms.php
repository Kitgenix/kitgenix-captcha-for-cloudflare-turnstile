...
class FormidableForms {
    ...
    public static function inject_turnstile($button, $form) {
        ...
        echo '<div class="cf-turnstile"'
           . \KitgenixCaptchaForCloudflareTurnstile\Core\Script_Handler::get_widget_data_attributes( 'formidableforms', $site_key ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- pre-escaped markup from Script_Handler.
    ...
    public static function validate_turnstile($errors, $values, $form_id) {
        ...
        if ( ! Turnstile_Validator::is_valid_submission( true, 'formidableforms' ) ) {
